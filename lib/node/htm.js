...
order( [
    ...
    void function () {
        ...
        /**
         * 創建節點清單： 見 {@link module:_docClass._createElement#_createNodeList} 。
         *
    ...
    void function () {
        ...
        function child( fnTagOpt ) {
            ...
            _txtHtml += _gapCharacter + _increaseIndent( '        ', _tag( _markHel, fnTagOpt ) );
            _markHel.main = '';
            return this;
        }
        ...
        function layoutTag( strTagName, objAttr, strChild ) {
            ...
            if ( strChild ) {
                txt += _gapCharacter
                    + _matchKeyWord( _increaseIndent( '            ', strChild ) );
            }
        ...
        function meta( objAttr ) {
            return this.layoutSingleTag( 'meta', objAttr );
        }
