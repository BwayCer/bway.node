...
void function () {
    ...
    var logNeedle, log, cacher, internWaiter;
    ...
    args[ idx++ ]( log, internWaiter, logNeedle, cacher );
}(
// defaultMsgTable
{
...
function yeseed( log, internWaiter, logNeedle, cacher ) {
