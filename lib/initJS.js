...
function ( log, _supportJS, _cacher ) {
    ...
    function internWaiter( objPreSource ) {
        this._cacher = new _cacher();
        this._waiting = new _cacher();

        if ( objPreSource ) internWaiter.assign( this._cacher, objPreSource );
     ...
     */
    internWaiter.assign = function ( insCacher, objSource ) {
        var key;
    ...
    _infoForm.prototype._parseId = function ( strId ) {
        ...
        if( this.self._blockParseId ) return [ strId ];
    ...
    _infoForm.prototype._parseDepId = function ( strDepId ) {
        ...
        if( this.self._blockParseId ) return [ strDepId ];
